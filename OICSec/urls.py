...
urlpatterns = [
    ...
    path('personal/direccion/editar-director/<int:personal_id>/',
         editar_director_view, name='editar_director'),
    path('personal/direccion/eliminar-director/<int:personal_id>/',
         eliminar_director_view, name='eliminar_director'),
    path("personal/direccion/crear_director/",
         crear_director_view, name='crear_director'),
    path('personal/direccion/editar-personal/<int:personal_id>/',
         editar_personal_direccion_view, name='editar_personal_direccion_view'),
    path('personal/direccion/eliminar-personal-direccion/<int:personal_id>/',
