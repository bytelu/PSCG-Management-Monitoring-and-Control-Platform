...
urlpatterns = [
    ...
    path("auditorias/archivos/<int:auditoria_id>/",
         auditoria_archivos_view, name="auditoria_archivos"),
    path("auditorias/archivos/<int:auditoria_id>/subir-archivo/",
         upload_archivo_auditoria, name='upload_auditoria_archivo'),
    ...
    path("controlesInternos/archivos/<int:control_id>/",
         control_archivos_view, name="control_archivos"),
    path("contorlesInternos/archivos/<int:control_id>/subir-archivo/",
         upload_archivo_control, name='upload_control_archivo'),
    ...
    path("intervenciones/archivos/<int:intervencion_id>/",
         intervencion_archivos_view, name="intervencion_archivos"),
    path("intervenciones/archivos/<int:intervencion_id>/subir-archivo/",
         upload_archivo_intervencion, name='upload_intervencion_archivo'),
